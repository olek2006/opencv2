...
PROTOXTX_DIR = os.path.join(MODELS_DIR, 'MobileNetSSD_deploy.prototxt.txt')
MODELS_PATH = os.path.join(MODELS_DIR, 'MobileNetSSD_deploy.caffemodel')
net = cv2.dnn.readNetFromCaffe(PROTOXTX_DIR, MODELS_PATH)
CLASSES = [
"background",
